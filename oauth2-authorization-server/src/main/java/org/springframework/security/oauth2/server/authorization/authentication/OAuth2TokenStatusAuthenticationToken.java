 ...
 */
public class OAuth2TokenStatusAuthenticationToken extends AbstractAuthenticationToken {
	...
	private final OAuth2TokenStatus tokenStatus;
	 ...
	 */
	public OAuth2TokenStatusAuthenticationToken(String token, Authentication clientPrincipal,
		...
		this.tokenStatus = OAuth2TokenStatus.inactive();
	}
	 ...
	 * @param token the token
	 * @param clientPrincipal the authenticated client principal
	 * @param tokenStatus the token claims
	 */
	public OAuth2TokenStatusAuthenticationToken(String token, Authentication clientPrincipal,
		...
		Assert.hasText(token, "token cannot be empty");
		Assert.notNull(clientPrincipal, "clientPrincipal cannot be null");
		Assert.notNull(tokenStatus, "tokenClaims cannot be null");
		this.token = token;
		this.clientPrincipal = clientPrincipal;
	 ...
	 */
	public OAuth2TokenStatus getTokenStatus() {
