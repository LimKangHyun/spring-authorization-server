...
public class OAuth2CustomGrantAuthenticationToken extends OAuth2AuthorizationGrantAuthenticationToken {
     ...
     */
    public OAuth2CustomGrantAuthenticationToken(Authentication clientPrincipal, @Nullable Set<String> scopes,
        @Nullable Map<String, Object> additionalParameters) {
        super(new AuthorizationGrantType("urn:custom:grant"), clientPrincipal, additionalParameters);
