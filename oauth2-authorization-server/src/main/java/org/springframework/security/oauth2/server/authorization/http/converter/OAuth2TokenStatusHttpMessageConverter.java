...
/**
 * A {@link HttpMessageConverter} for an {@link OAuth2TokenStatus OAuth 2.0 Token
 * Status Response}.
 *
 * @author Gerardo Roza
 * @author Joe Grandja
 ...
 * @see OAuth2TokenStatus
 */
public class OAuth2TokenStatusHttpMessageConverter
		extends AbstractHttpMessageConverter<OAuth2TokenStatus> {
	...
	private Converter<Map<String, Object>, OAuth2TokenStatus> tokenStatusConverter = new MapOAuth2TokenIntrospectionConverter();

	private Converter<OAuth2TokenStatus, Map<String, Object>> tokenStatusParametersConverter = new OAuth2TokenIntrospectionMapConverter();

	public OAuth2TokenStatusHttpMessageConverter() {
		super(MediaType.APPLICATION_JSON, new MediaType("application", "*+json"));
	}

	@Override
	protected boolean supports(Class<?> clazz) {
		return OAuth2TokenStatus.class.isAssignableFrom(clazz);
	}

	@Override
	@SuppressWarnings("unchecked")
	protected OAuth2TokenStatus readInternal(Class<? extends OAuth2TokenStatus> clazz,
			HttpInputMessage inputMessage) throws HttpMessageNotReadableException {
		try {
			Map<String, Object> tokenStatusParameters = (Map<String, Object>) this.jsonMessageConverter
					.read(STRING_OBJECT_MAP.getType(), null, inputMessage);
			return this.tokenStatusConverter.convert(tokenStatusParameters);
		}
		catch (Exception ex) {
	...
	@Override
	protected void writeInternal(OAuth2TokenStatus tokenIntrospection, HttpOutputMessage outputMessage)
			throws HttpMessageNotWritableException {
		try {
			Map<String, Object> tokenIntrospectionResponseParameters = this.tokenStatusParametersConverter
	 ...
	 * parameters to an {@link OAuth2TokenStatus}.
	 * @param tokenIntrospectionConverter the {@link Converter} used for converting to an
	 * {@link OAuth2TokenStatus}
	 */
	public final void setTokenIntrospectionConverter(
			Converter<Map<String, Object>, OAuth2TokenStatus> tokenIntrospectionConverter) {
		Assert.notNull(tokenIntrospectionConverter, "tokenIntrospectionConverter cannot be null");
		this.tokenStatusConverter = tokenIntrospectionConverter;
	}

	/**
	 * Sets the {@link Converter} used for converting an {@link OAuth2TokenStatus}
	...
	public final void setTokenIntrospectionParametersConverter(
			Converter<OAuth2TokenStatus, Map<String, Object>> tokenIntrospectionParametersConverter) {
		Assert.notNull(tokenIntrospectionParametersConverter, "tokenIntrospectionParametersConverter cannot be null");
		this.tokenStatusParametersConverter = tokenIntrospectionParametersConverter;
	}

	private static final class MapOAuth2TokenIntrospectionConverter
			implements Converter<Map<String, Object>, OAuth2TokenStatus> {
		...
		@Override
		public OAuth2TokenStatus convert(Map<String, Object> source) {
			Map<String, Object> parsedClaims = this.claimTypeConverter.convert(source);
			return OAuth2TokenStatus.withClaims(parsedClaims).build();
		}
	...
	private static final class OAuth2TokenIntrospectionMapConverter
			implements Converter<OAuth2TokenStatus, Map<String, Object>> {

		@Override
		public Map<String, Object> convert(OAuth2TokenStatus source) {
