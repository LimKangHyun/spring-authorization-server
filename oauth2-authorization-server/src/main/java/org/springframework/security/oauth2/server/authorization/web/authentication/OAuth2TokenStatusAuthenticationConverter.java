 ...
 * converts it to an {@link OAuth2TokenStatusAuthenticationToken} used for
 ...
 */
public final class OAuth2TokenStatusAuthenticationConverter implements AuthenticationConverter {
	...
	public Authentication convert(HttpServletRequest request) {
		...
		return new OAuth2TokenStatusAuthenticationToken(token, clientPrincipal, tokenTypeHint,
