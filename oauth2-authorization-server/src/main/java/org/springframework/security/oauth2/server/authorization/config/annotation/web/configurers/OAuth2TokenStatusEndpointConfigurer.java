...
import org.springframework.security.oauth2.server.authorization.web.OAuth2TokenStatusEndpointFilter;
 ...
 * @author Joe Grandja
 * @since 0.2.3
 * @see OAuth2AuthorizationServerConfigurer#tokenStatusEndpoint(Customizer)
 * @see OAuth2TokenStatusEndpointFilter
 */
public final class OAuth2TokenStatusEndpointConfigurer extends AbstractOAuth2Configurer {
	 ...
	 */
	OAuth2TokenStatusEndpointConfigurer(ObjectPostProcessor<Object> objectPostProcessor) {
	 ...
	 * @return the {@link OAuth2TokenStatusEndpointConfigurer} for further
	 * configuration
	 */
	public OAuth2TokenStatusEndpointConfigurer introspectionRequestConverter(
	 ...
	 * @since 0.4.0
	 */
	public OAuth2TokenStatusEndpointConfigurer introspectionRequestConverters(
	 ...
	 * authenticating a type of {@link OAuth2TokenStatusAuthenticationToken}
	 * @return the {@link OAuth2TokenIntrospectionEndpointConfigurer} for further
	 * configuration
	 */
	public OAuth2TokenStatusEndpointConfigurer authenticationProvider(
	 ...
	 * @since 0.4.0
	 */
	public OAuth2TokenStatusEndpointConfigurer authenticationProviders(
	 ...
	 * configuration
	 */
	public OAuth2TokenStatusEndpointConfigurer introspectionResponseHandler(
	 ...
	 * configuration
	 */
	public OAuth2TokenStatusEndpointConfigurer errorResponseHandler(
	...
	void configure(HttpSecurity httpSecurity) {
		...
		String tokenIntrospectionEndpointUri = authorizationServerSettings.isMultipleIssuersAllowed()
				...
				.withMultipleIssuersPattern(authorizationServerSettings.getTokenIntrospectionEndpoint())
				: authorizationServerSettings.getTokenIntrospectionEndpoint();
		OAuth2TokenStatusEndpointFilter introspectionEndpointFilter = new OAuth2TokenStatusEndpointFilter(
	...
	private static List<AuthenticationConverter> createDefaultAuthenticationConverters() {
		...
		authenticationConverters.add(new OAuth2TokenStatusAuthenticationConverter());
	...
	private static List<AuthenticationProvider> createDefaultAuthenticationProviders(HttpSecurity httpSecurity) {
		...
		OAuth2TokenStatusAuthenticationProvider tokenIntrospectionAuthenticationProvider = new OAuth2TokenStatusAuthenticationProvider(
